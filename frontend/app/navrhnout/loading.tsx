  ...
  return (
    <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="space-y-6 opacity-60">
        <div className="surface-card p-6 h-32 flex items-center justify-center">
          <Loader2 className="w-8 h-8 animate-spin text-muted-foreground/50" />
        </div>
        <div className="surface-card p-6 h-96 bg-muted/20 animate-pulse" />
        <div className="surface-card p-6 h-32 bg-muted/20 animate-pulse" />
