      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="flex gap-2">
            <div className="w-20 h-6 bg-muted animate-pulse rounded-md"></div>
            <div className="w-24 h-6 bg-muted animate-pulse rounded-md"></div>
            <div className="w-16 h-6 bg-muted animate-pulse rounded-md"></div>
          </div>
        ...
        <div className="space-y-6">
          <div className="surface-card p-6 flex flex-col items-center justify-center space-y-4 min-h-[200px]">
