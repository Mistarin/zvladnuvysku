ALTER TABLE public.subject_materials
  DROP CONSTRAINT IF EXISTS subject_materials_points_override_check;

ALTER TABLE public.subject_materials
  ADD CONSTRAINT subject_materials_points_override_check
  CHECK (points_override IS NULL OR points_override BETWEEN 1 AND 4);
