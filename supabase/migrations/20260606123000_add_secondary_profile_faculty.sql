ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS secondary_faculty text;
...
ALTER TABLE public.profiles
  ...
  CHECK (
    (faculty IS NULL OR faculty IN ('FSS', 'FU', 'FF', 'LF', 'PdF', 'PřF'))
    AND (secondary_faculty IS NULL OR secondary_faculty IN ('FSS', 'FU', 'FF', 'LF', 'PdF', 'PřF'))
    AND (secondary_faculty IS NULL OR faculty IS NOT NULL)
    AND (secondary_faculty IS NULL OR faculty IS DISTINCT FROM secondary_faculty)
  );
