...
INSERT INTO subjects (slug, name, short_tag, description, target_audience, real_requirements, difficulty, time_intensity, attendance_type, attendance_required, credits, semester, faculty, department, year) VALUES
...
('uvod-do-programovani', 'Úvod do programování', 'UPR',
  ...
  2, 3, 'required', true, 6, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 1),
...
('matematika-1', 'Matematika 1', 'MA1',
  ...
  5, 5, 'required', true, 8, 'zimní', 'Přírodovědecká fakulta', 'Katedra matematiky', 1),
...
('algoritmy-a-datove-struktury', 'Algoritmy a datové struktury', 'ADS',
  ...
  4, 4, 'optional', false, 6, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 1),
...
('logika-a-diskretni-matematika', 'Logika a diskrétní matematika', 'LDM',
  ...
  4, 4, 'optional', false, 6, 'zimní', 'Přírodovědecká fakulta', 'Katedra matematiky', 1),
...
('databazove-systemy', 'Databázové systémy', 'DBS',
  ...
  3, 3, 'optional', false, 6, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 2),
...
('operacni-systemy', 'Operační systémy', 'OS',
  ...
  4, 4, 'required', true, 6, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 2),
...
('pocitacove-site', 'Počítačové sítě', 'PSI',
  ...
  3, 3, 'optional', false, 5, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 2),
...
('softwarove-inzenyrstvi', 'Softwarové inženýrství', 'SWI',
  ...
  3, 4, 'required', true, 6, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 3),
...
('umela-inteligence', 'Umělá inteligence', 'UI',
  ...
  4, 4, 'optional', false, 6, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 3),
...
('webove-technologie', 'Webové technologie', 'WT',
  ...
  3, 3, 'optional', false, 5, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 2),
...
('pocitacova-grafika', 'Počítačová grafika', 'PG',
  ...
  4, 4, 'optional', false, 5, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 3),
...
('bezpecnost-informacnich-systemu', 'Bezpečnost informačních systémů', 'BIS',
  ...
  3, 3, 'optional', false, 5, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 3),
...
('kompilatory', 'Překladače', 'PJP',
  ...
  5, 5, 'optional', false, 6, 'zimní', 'Přírodovědecká fakulta', 'Katedra informatiky', 3),
...
('pocitace-a-architektura', 'Počítače a architektura', 'PAR',
  ...
  3, 3, 'optional', false, 5, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 1),
...
('matematika-2', 'Matematika 2', 'MA2',
  ...
  5, 5, 'required', true, 8, 'letní', 'Přírodovědecká fakulta', 'Katedra matematiky', 1),
...
('statistika', 'Statistika a pravděpodobnost', 'STA',
  ...
  3, 3, 'optional', false, 5, 'zimní', 'Přírodovědecká fakulta', 'Katedra matematiky', 2),
...
('teorie-vypoctu', 'Teorie výpočtu', 'TVY',
  ...
  4, 3, 'optional', false, 5, 'letní', 'Přírodovědecká fakulta', 'Katedra informatiky', 2),
...
('seminare-z-programovani', 'Seminář z programování', 'SEM',
  ...
  2, 2, 'required', true, 2, 'oba', 'Přírodovědecká fakulta', 'Katedra informatiky', 1);
